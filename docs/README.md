...
|----------|-------------|
| [Architecture](./ARCHITECTURE.md) | System design, state management, and technical decisions |
| [Components](./COMPONENTS.md) | React component reference with props and patterns |
| [Deployment](./DEPLOYMENT.md) | Deploy to Vercel guide |
| [Security](./SECURITY.md) | Security practices and data privacy |
